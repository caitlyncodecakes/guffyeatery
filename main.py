...
rightarrow = pygame.image.load('img/arrows/rightlarge.png')
rightarrow_rect = pygame.Rect(SCREENWIDTH-240, SCREENHEIGHT-300, 200, 110)
larrow = pygame.image.load('img/arrows/leftlarge.png')
larrow_rect = pygame.Rect(SCREENWIDTH-600, SCREENHEIGHT-300, 200, 110)
uarrow = pygame.image.load('img/arrows/uplarge.png')
uarrow_rect = pygame.Rect(SCREENWIDTH-380, SCREENHEIGHT-450, 110, 200)
darrow = pygame.image.load('img/arrows/downlarge.png')
darrow_rect = pygame.Rect(SCREENWIDTH-380, SCREENHEIGHT-200, 110, 200)
